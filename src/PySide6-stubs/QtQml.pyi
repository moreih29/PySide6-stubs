...
class QJSValue(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, str: str | bytes | bytearray | memoryview, /) -> None: ...
    @typing.overload
    def __init__(self, value: bool, /) -> None: ...
    @typing.overload
    def __init__(self, value: int, /) -> None: ...
...
class QQmlExtensionInterface(PySide6.QtQml.QQmlTypesExtensionInterface):
    ...
    def initializeEngine(self, engine: PySide6.QtQml.QQmlEngine, uri: str | bytes | bytearray | memoryview, /) -> None: ...
...
class QQmlExtensionPlugin(PySide6.QtCore.QObject, PySide6.QtQml.QQmlExtensionInterface):
    ...
    def baseUrl(self, /) -> PySide6.QtCore.QUrl: ...
    def initializeEngine(self, engine: PySide6.QtQml.QQmlEngine, uri: str | bytes | bytearray | memoryview, /) -> None: ...
    def registerTypes(self, uri: str | bytes | bytearray | memoryview, /) -> None: ...
...
class QQmlFile(Shiboken.Object):
    ...
    @typing.overload
    def connectDownloadProgress(self, arg__1: PySide6.QtCore.QObject, arg__2: str | bytes | bytearray | memoryview, /) -> bool: ...
    @typing.overload
    def connectDownloadProgress(self, arg__1: PySide6.QtCore.QObject, arg__2: int, /) -> bool: ...
    @typing.overload
    def connectFinished(self, arg__1: PySide6.QtCore.QObject, arg__2: str | bytes | bytearray | memoryview, /) -> bool: ...
    @typing.overload
...
class QQmlListReference(Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    @typing.overload
    def __init__(self, o: PySide6.QtCore.QObject, property: str | bytes | bytearray | memoryview, /) -> None: ...
    @typing.overload
    def __init__(self, o: PySide6.QtCore.QObject, property: str | bytes | bytearray | memoryview, engine: PySide6.QtQml.QQmlEngine, /) -> None: ...
    @typing.overload
...
class QQmlProperty(Shiboken.Object):
    ...
    @typing.overload
    def connectNotifySignal(self, dest: PySide6.QtCore.QObject, slot: str | bytes | bytearray | memoryview, /) -> bool: ...
    @typing.overload
